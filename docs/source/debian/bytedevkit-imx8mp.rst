...
.. list-table::
    ...
    * - Download
      - Checksum (SHA256)
    * - `debian13_m7.img.zst <https://download.bytesatwork.io/transfer/bytesatwork/debian/debian13_m7.img.zst>`_
      - 5e7d9a73c7e22e99f530e93a897e87b67a430f8a189838dd96281bbd5c28c538
...
Windows
   ...
   #. Unzip the file ``debian13_m7.img.zst`` (e.g. with 7-zip)
...
::
  ...
  zstd -d debian13_m7.img.zst | dd of=/dev/mmcblk<X> bs=8M conv=fsync status=progress
