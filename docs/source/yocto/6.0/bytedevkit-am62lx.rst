...
.. list-table::
     ...
     * - Description
       ...
       - Checksum (SHA256)
     * - SPL R5F
       - `tiboot3.bin <https://download.bytesatwork.io/transfer/bytesatwork/bytedevkit-am62lx/6.0.3/tiboot3.bin>`_
       - 98001b77d556280717d210ac7a71ef39d592bb3b45154c9c6d611a5eb091999e
     * - SPL A53
       - `tispl.bin <https://download.bytesatwork.io/transfer/bytesatwork/bytedevkit-am62lx/6.0.3/tispl.bin>`_
       - c1caea8eac81e98330558701bd6495299dfe00015aa33165bfb88a6927d14e49
     * - U-Boot A53
       - `u-boot.img <https://download.bytesatwork.io/transfer/bytesatwork/bytedevkit-am62lx/6.0.3/u-boot.img>`_
       - dcd44a962a1941e9305e1981235e8c71d1a4a7a63e513c730864f609d2e0f919
...
::
   ...
   $ mkdir -p ~/workdir/bytedevkit-am62lx/6.0; cd ~/workdir/bytedevkit-am62lx/6.0
   $ repo init -b wrynose -u https://github.com/bytesatwork/bsp-platform-ti.git
   $ repo sync

If those commands are completed successfully, the following command
will set up a Yocto Project environment for bytedevkit-am62lx:

::

   $ cd ~/workdir/bytedevkit-am62lx/6.0
...
::
   ...
   ~/workdir/bytedevkit-am62lx/6.0/build/deploy-ti/images/bytedevkit-am62lx
...
-----------------------
  ...
  The image recipes can be found in ``~/workdir/bytedevkit-am62lx/6.0/sources/meta-bytesatwork/recipes-core/images``
...
If you want to rename or copy an image, simply rename or copy the image recipe by:
   ...
   ::
    ...
    $ cd ~/workdir/bytedevkit-am62lx/6.0/sources/meta-bytesatwork/recipes-core/images
...
-  **Image size is too small**
   ...
   ``~/workdir/bytedevkit-am62lx/6.0/sources/meta-bytesatwork/recipes-core/images/bytesatwork-minimal-image.bb``.
...
::
   ...
   source /opt/poky-bytesatwork/6.0.3/environment-setup-aarch64-poky-linux
...
::
      ...
      aarch64-poky-linux-gcc -mbranch-protection=standard -fstack-protector-strong -O2 -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security --sysroot=/opt/poky-bytesatwork/6.0.3/sysroots/aarch64-poky-linux
...
::
   ...
   helloworld: ELF 64-bit LSB pie executable, ARM aarch64, version 1 (SYSV), dynamically linked, interpreter /usr/lib/ld-linux-aarch64.so.1, BuildID[sha1]=b9894bf923071d7780f4c9d6a02291a557644053, for GNU/Linux 5.15.0, with debug_info, not stripped
...
::
   ...
   ~/workdir/bytedevkit-am62lx/6.0/build/deploy-ti/sdk

How to modify your toolchain
----------------------------

Currently the bytesatwork toolchain is generated out of the bytesatwork-sdk-image recipe. If you want to add additional libraries and development headers to customize the toolchain, you need to modify the bytesatwork-minimal-image recipe. It can be found under ``~/workdir/bytedevkit-am62lx/6.0/sources/meta-bytesatwork/recipes-core/images``

For example: if you want to develop your own application utilizing CAN communication and need libsocketcan and the corresponding header files, edit the recipe ``bytesatwork-sdk-image.bb`` and add ``libsocketcan`` to the ``IMAGE_INSTALL`` variable.
...
.. _download-kernel-bytedevkit-am62lx-6.0:
...
.. list-table::
    ...
    * - Device
      ...
      - git URL
    * - bytedevkit-am62lx
      - baw-ti-linux-6.18.y-12.00.00.07
...
provided toolchain from :ref:`get-toolchain-bytedevkit-am62lx-6.0` or any compatible toolchain (e.g.
...
#. Download kernel sources
   ...
   Download the appropriate kernel from :ref:`download-kernel-bytedevkit-am62lx-6.0`.


#. Activate the SDK
   ::

      export SDK=/opt/poky-bytesatwork/6.0.3
      export ARCH=arm64
      export CROSS_COMPILE=$SDK/sysroots/x86_64-pokysdk-linux/usr/bin/aarch64-poky-linux/aarch64-poky-linux-

#. Create defconfig

   ::

      make bytedevkit_am62lx_defconfig
...
#.  Install kernel modules
    ...
    ::
       ...
       mkdir /tmp/bytedevkit-am62lx
       make INSTALL_MOD_PATH=/tmp/bytedevkit-am62lx modules_install

   Now you can copy the content of the folder ``/tmp/bytedevkit-am62lx`` into the
...
******
   ...
   .. _download-uboot-source-bytedevkit-am62lx-6.0:
...
===========================
   ...
   .. list-table::
        ...
        * - Device
          ...
          - git URL
        * - bytedevkit-am62lx
          - baw-ti-u-boot-2026.01_12.00.00.07
...
#. Install and get Dependencies
   ...
   - `Cross toolchain <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/linux/Overview/GCC_ToolChain.html#toolchains>`_
   - `TI-linux-firmware <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/devices/AM62X/linux/Release_Specific_Release_Notes.html#arago-yocto-oe>`_
   - `TF-A <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/devices/AM62X/linux/Release_Specific_Release_Notes.html#arago-yocto-oe>`_
   - `OP-TEE <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/devices/AM62X/linux/Release_Specific_Release_Notes.html#arago-yocto-oe>`_
...
#. Build TF-A
   ...
   `TI TF-A build instructions <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/linux/Foundational_Components_ATF.html>`_

#. Build OP-TEE

   `TI OP-TEE build instructions <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/linux/Foundational_Components_OPTEE.html>`_

#. Build u-boot

   You should have downloaded TI-linux-firmware and built TF-A, OP-TEE OS already.

   `TI u-boot build instructions <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/linux/Foundational_Components_U-Boot.html>`_

   .. Important::
      Use ``am62lx_bytedevkit_r5_defconfig`` and ``am62lx_bytedevkit_a53_defconfig`` instead of the TI
      defconfigs.
...
-------
   ...
   .. Hint::
      Copy the related files to SD card, see
      `TI u-boot instructions <https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/12_00_00_07_04/exports/docs/linux/Foundational_Components/U-Boot/UG-Memory-K3.html#flashing-an-sd-card-from-a-host-pc>`_
